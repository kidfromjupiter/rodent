...
#ifndef __sdbuscpp___home_lasan_Dev_rodent_generated_bluez_proxies_org_bluez_Adapter1_proxy_h__proxy__H__
#define __sdbuscpp___home_lasan_Dev_rodent_generated_bluez_proxies_org_bluez_Adapter1_proxy_h__proxy__H__
...
public:
    ...
    bool Connectable()
    {
        return m_proxy.getProperty("Connectable").onInterface(INTERFACE_NAME).get<bool>();
    }

    void Connectable(const bool& value)
    {
        m_proxy.setProperty("Connectable").onInterface(INTERFACE_NAME).toValue(value);
    }
    ...
    {
        return m_proxy.getProperty("Manufacturer").onInterface(INTERFACE_NAME).get<uint16_t>();
    }

    uint8_t Version()
    {
        return m_proxy.getProperty("Version").onInterface(INTERFACE_NAME).get<uint8_t>();
    }
