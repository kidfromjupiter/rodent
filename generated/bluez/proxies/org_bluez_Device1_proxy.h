...
#ifndef __sdbuscpp___home_lasan_Dev_rodent_generated_bluez_proxies_org_bluez_Device1_proxy_h__proxy__H__
#define __sdbuscpp___home_lasan_Dev_rodent_generated_bluez_proxies_org_bluez_Device1_proxy_h__proxy__H__
...
public:
    ...
    std::vector<std::vector<uint8_t>> GetServiceRecords()
    {
        std::vector<std::vector<uint8_t>> result;
        m_proxy.callMethod("GetServiceRecords").onInterface(INTERFACE_NAME).storeResultsTo(result);
        return result;
    }
...
public:
    ...
    bool CablePairing()
    {
        return m_proxy.getProperty("CablePairing").onInterface(INTERFACE_NAME).get<bool>();
    }
    ...
    std::string PreferredBearer()
    {
        return m_proxy.getProperty("PreferredBearer").onInterface(INTERFACE_NAME).get<std::string>();
    }

    void PreferredBearer(const std::string& value)
    {
        m_proxy.setProperty("PreferredBearer").onInterface(INTERFACE_NAME).toValue(value);
    }
